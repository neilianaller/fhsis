<!-- jQuery -->
<script src="<?= base_url('public/dist/plugins/jquery/jquery-3.7.1.min.js') ?>"></script>
<!-- jQuery -->
...
<!-- SweetAlert2 -->
<script src="<?= base_url('public/dist/plugins/sweetalert2/sweetalert2.all.js') ?>"></script>
<script src="<?= base_url('public/dist/plugins/sweetalert2/sweetalert2.all.min.js') ?>"></script>
